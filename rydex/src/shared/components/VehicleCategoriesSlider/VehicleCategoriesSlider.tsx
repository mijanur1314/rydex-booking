        ...
        <div className="relative">
          ...
          <AnimatePresence>
            {canLeft && (
              <motion.div
                ...
                className="absolute left-0 top-0 bottom-0 w-20 bg-gradient-to-r from-white to-transparent z-10 pointer-events-none lg:hidden"
              />
            )}
          </AnimatePresence>
          ...
          <AnimatePresence>
            {canRight && (
              <motion.div
                initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                className="absolute right-0 top-0 bottom-0 w-20 bg-gradient-to-l from-white to-transparent z-10 pointer-events-none lg:hidden"
              />
            )}
          </AnimatePresence>
          ...
          <div
            ref={sliderRef}
            onScroll={onScroll}
            className="flex gap-5 pt-20 overflow-x-auto scroll-smooth pb-4 px-1 lg:grid lg:grid-cols-3 xl:grid-cols-6 lg:gap-6 lg:overflow-visible lg:px-0"
            ...
            {VEHICLE_CATEGORIES.map((item, i) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -8 }}
                  className="group relative min-w-[220px] sm:min-w-[260px] flex-shrink-0 cursor-pointer lg:min-w-0 lg:w-full"
